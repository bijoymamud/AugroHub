...
const navItems = <>
  ...
  <li tabIndex={0}>
    <Link className='font-bold text-lg' to="/findDoc">About Us</Link>
  ...
  <li tabIndex={0}>
    <Link className='font-bold text-lg' to="/">Pages</Link>
  </li>
  <li tabIndex={0}>
    <Link className='font-bold text-lg' to="/">Blogs</Link>
  </li>
      ...
      <div className="navbar-end">
        <div className='flex items-center gap-5'>
          ...
          <div className="indicator md:flex items-center md:me-10">
            ...
            <Link className='md:ms-5 btn btn-active bg-black border-none text-white hover:bg-sky-600 btn-accent' to="/">Shop Now</Link>
